...
export default memo(() => {
  ...
  const openIssuePage = () => {
    void openUrl(`${PROJECT_URL}/issues`)
  }
  const openGHReleasePage = () => {
    void openUrl(`${PROJECT_URL}/releases`)
  }
  ...
  const openPartPage = () => {
    void openUrl(`${PROJECT_URL}#%E8%AE%B8%E5%8F%AF%E4%B8%8E%E5%85%8D%E8%B4%A3%E5%A3%B0%E6%98%8E`)
  }
  ...
  return (
    <Section title={t('setting_about')}>
      ...
      <View style={styles.part}>
        <Text style={styles.text}>Q-music 基于 LX Music Mobile 二次开发，感谢 lyswhut 与所有上游贡献者。</Text>
      </View>
    </Section>
  )
})
