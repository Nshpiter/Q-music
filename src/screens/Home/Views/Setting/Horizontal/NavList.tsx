...
const ITEM_HEIGHT = Math.max(scaleSizeH(Q_UI.touchSize), Q_UI.touchSize)
  ...
  return (
    <TouchableOpacity
      ...
      style={{
        ...
        borderColor: active ? theme['q-outline'] : 'transparent',
      }}
      onPress={handlePress}
    >
      {
        active
          ? <Icon style={styles.listActiveIcon} name="chevron-right" size={12} color={theme['q-accent-text']} />
          : null
      }
