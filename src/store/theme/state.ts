...
const state: InitState = {
  ...
  theme: {
    ...theme,
    'c-app-background': theme['c-primary-light-600-alpha-800'],
    ...
    'c-font': theme['c-850'],
    'c-font-label': theme['c-650'],
    'c-primary-font': theme['c-primary-dark-500'],
    'c-primary-font-hover': theme['c-primary-dark-500'],
    'c-primary-font-active': theme['c-primary-dark-500'],
    'c-primary-background': theme['c-primary-alpha-900'],
    'c-primary-background-hover': theme['c-primary-alpha-800'],
    'c-primary-background-active': theme['c-primary-alpha-700'],
    'c-primary-input-background': theme['c-primary-alpha-900'],
    'c-button-font': theme['c-primary-dark-500'],
    'c-button-font-selected': theme['c-primary-dark-500'],
    'c-button-background': theme['c-primary-alpha-800'],
    'c-button-background-selected': theme['c-primary-alpha-700'],
    'c-button-background-hover': theme['c-primary-alpha-800'],
    'c-button-background-active': theme['c-primary-alpha-700'],
    'c-list-header-border-bottom': 'rgba(40, 50, 66, 0.14)',
    'c-content-background': theme['c-primary-light-1000'],
    'c-border-background': 'rgba(40, 50, 66, 0.14)',
    'q-surface-base': theme['c-primary-light-1000-alpha-500'],
    'q-surface-raised': theme['c-primary-light-1000-alpha-200'],
    'q-surface-tint': theme['c-primary-alpha-800'],
    'q-text-primary': theme['c-850'],
    'q-text-secondary': theme['c-650'],
    'q-accent': theme['c-primary'],
    'q-accent-text': theme['c-primary-dark-500'],
    'q-on-accent': '#212121',
