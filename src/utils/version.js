...
const githubOwner = 'Nshpiter'
const githubRepo = 'Q-music'
const versionInfoPath = 'publish/mobile-version.json'
const apkAssetName = 'Q-music-android'
...
const address = [
  [`https://raw.githubusercontent.com/${githubOwner}/${githubRepo}/master/${versionInfoPath}`, 'direct'],
  [`https://cdn.jsdelivr.net/gh/${githubOwner}/${githubRepo}@master/${versionInfoPath}`, 'direct'],
  [`https://fastly.jsdelivr.net/gh/${githubOwner}/${githubRepo}@master/${versionInfoPath}`, 'direct'],
  [`https://gcore.jsdelivr.net/gh/${githubOwner}/${githubRepo}@master/${versionInfoPath}`, 'direct'],
]
...
export const downloadNewVersion = async(version, onDownload = noop) => {
  ...
  const url = `https://github.com/${githubOwner}/${githubRepo}/releases/download/v${version}/${apkAssetName}-v${version}-${abi}.apk`
  const savePath = temporaryDirectoryPath + '/q-music-android.apk'
