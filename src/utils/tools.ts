...
export const getRowInfo = (_type: RowInfoType = 'full'): RowInfo => {
  // 手机端固定单列。键盘 adjustResize 只改变可见窗口比例，不代表设备变成平板。
  return {
    rowNum: undefined,
    rowWidth: '100%',
  }
...
export const cheatTip = async() => {
  ...
  return tipDialog({
    title: '谨防被骗提示',
    message: `1. Q-music 移动版当前仅通过项目 GitHub Releases 发布，其他来源的安装包请谨慎鉴别。\n
